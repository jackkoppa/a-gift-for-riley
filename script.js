(function() {
  ...
  Main = (function() {
    ...
    Main.prototype.suggestScroll = function() {
      return (this.scrollSuggestTween = TweenMax.to(this.$scrollSuggest, 0.5, {
        y: 10,
        repeat: -1,
        opacity: 1,
        yoyo: true,
    ...
    Main.prototype.updateScrollPos = function(that, it) {
      ...
      return it.controller
        .setScrollContainerOffset(0, -(that.y >> 0))
    ...
    Main.prototype.isChromeFix = function() {
      var ver, _ref;
      ver = parseInt(
        (_ref = window.navigator.appVersion.match(/Chrome\/(\d+)\./)) != null
          ? _ref[1]
          : void 0,
        10
      );
      return (
        ver > 33 && navigator.userAgent.toLowerCase().indexOf("chrome") > -1
      );
    };
